...
import "restaurant-service/internal/domain/restaurant"
...
func WithRestaurantRepository(restaurantRepository restaurant.Repository) Configuration {
	// return a function that matches the Configuration alias,
	// You need to return this so that the parent function can take in all the needed parameters
	return func(s *Service) error {
		s.restaurantRepository = restaurantRepository
		return nil
	}
}
