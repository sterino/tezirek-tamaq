...
const file_proto_auth_proto_rawDesc = "" +
	"\n" +
	"\x10proto/order.proto\x12\x04auth\"W\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token2x\n" +
	"\vAuthService\x127\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x14.auth.UserIDResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.TokenResponseB&Z$user-service/proto/gen/authpb;authpbb\x06proto3"
...
var file_proto_auth_proto_depIdxs = []int32{
	...
	2, // 2: auth.AuthService.Register:output_type -> auth.UserIDResponse
